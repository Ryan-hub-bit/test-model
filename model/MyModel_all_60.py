...
def init_dataset(Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe = False):
    dataset = iCallds_all_60.iCallds2(Revedges=Revedges, Calledges=Calledges, Laplacian_pe=Laplacian_pe,
...
# def main():
    ...
    #          5151,
    #          ]
    skips = [1362,1493,1275,1170,997,1054,1100,1394,626,178]
    hidden_features = 512
    inslen = 60
    device = th.device("cuda" if th.cuda.is_available() else "cpu")
    savedir = "/home/isec/test/model" + "/result_all" +"_" + str(inslen)
