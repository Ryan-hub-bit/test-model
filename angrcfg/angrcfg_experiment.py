...
binary_folder = "/home/isec/Documents/differentopdata/Reorganized_Dataset/O0/valid_binary_list"
#graphdir = "/home/isec/Documents/angr_experiment_1/dir"
...
# def savebin(filemd5, g, funcsave):
#     global naming, logf
#     logf.write(str(naming)+','+filemd5+'\n')
#     #graph_labels = {"GT_label": th.tensor(GT_edges)}
#     dgl.data.utils.save_graphs(os.path.join(graphdir, str(naming) + ".graph"), [g])
    ...
    for file in files:
        ...
        for key, value in nodelookup.items():
            if value is not None:
                ...
                id = value.id
                addrtoid[key] = id
        binandaddr = binary_file + "_addrtoid.json"
        # File path
        file_path = os.path.join(addrtodir, binandaddr)
        # Writing to JSON file
        with open(file_path, 'w') as json_file:
            json.dump(addrtoid, json_file, indent=4)
        ...
        #savebin(filemd5=binfile, g=g,funcsave=funcsave)
