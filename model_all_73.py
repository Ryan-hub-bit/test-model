...
def init_dataset(Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe = False):
    dataset = iCallds_all_70.iCallds2(Revedges=Revedges, Calledges=Calledges, Laplacian_pe=Laplacian_pe,
...
# def main():
    ...
    skips = [371,374,394,926,436,800,975,127,1175,1210,1400]
    hidden_features = 512
    inslen = 70
